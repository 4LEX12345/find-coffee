  ...
  <div class="font-body text-gray-800">
    <header class="fixed w-full top-0 text-white px-4 py-6 z-50 md:bg-transparent bg-black/40">
      <nav class="md:px-10 mx-auto flex justify-between items-center">
        ...
        <!-- Cart Button -->
        <div class="relative">
          <button @click="showCart = true" class="relative p-2 rounded-full hover:bg-black/20 transition bg-black/40 px-5 py-2  backdrop-blur-xl">
            ...
            <button class="opacity-0 relative p-2 rounded-full hover:bg-black/20 transition bg-black/40 px-5 py-2  backdrop-blur-xl">
          </button>
        </div>
      </nav>
    </header>
